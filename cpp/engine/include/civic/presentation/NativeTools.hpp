...
using NativeToolDraft = std::variant<std::monostate, RoadToolDraft, ZoneToolDraft, FacilityToolDraft, TransitToolDraft>;
...
private:
    ...
    ToolPreviewState preview_{.tool_id = "inspect"};
