...
const fixtures = [
  ...
  name: string;
  revision: number;
  cells: readonly ShadowRoadCell[];
  start: string;
  end: string;
}[];

test(
  "C++ transportation shadow matches accepted TypeScript network and routing fixtures",
  { skip: !nativePath },
  () => {
